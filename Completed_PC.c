...
int main()
{
    ...
    do {
        ...
        while ((sel = getchar()) == '\n');
        switch (sel) {
        //Case 1 for control door
        case '1':
                //Choice door
                printf("\nEnter door id u wana control ");
                printf("\nPress '1': Control door A ");
                printf("\nPress '2': Control door B ");
                printf("\nDoor ID: ");
                int door_id;
                scanf("%d",&door_id);
                //Choice Status
                ...
                printf("\nCompleted control door");
            break;
        //Case 2 for control light
        case '2':
            //Choice light
            ...
            break;
        //Case 3 for Read status door
        case '3':
            //Choice door wana read status
            printf("\nEnter door id u wana read status ");
            printf("\nPress '1': Read status door A ");
            printf("\nPress '2': Read status door B ");
            printf("\nDoor ID: ");
            int door_id_status;
            scanf("%d", &door_id_status);

            CMD = READ_STATUS_DOOR;
